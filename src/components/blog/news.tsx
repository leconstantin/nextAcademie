        ...
        <div className="grid grid-cols-1 gap-8 mt-8 lg:grid-cols-2">
          <div>
            ...
            <div className="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
              ...
              <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 md:text-sm">
                ...
                another exciting school year, we&apos;re here to share some
                helpful tips to ensure that students are ready for success, both
                inside and outside the classroom. Whether you&apos;re starting
                the year as a returning student or joining us for the first
                time, we&apos;ve got everything you need to make this school
                year your best one yet.
              </p>
          ...
          <div>
            ...
            <div className="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
              ...
              <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 md:text-sm">
                The new semester is here, and it&apos;s packed with exciting
                events and activities designed to bring our school community
                together. Whether you&apos;re a student, parent, or teacher,
                there&apos;s something for everyone to look forward to. From
                school spirit days to academic showcases, this semester promises
                to be one for the books! Here&apos;s a sneak peek at the events
